...
static void InitSpells(void){
	...
	// NOTE: If no external configuration file is present, fall back to the
	// built-in static spell table to preserve the original behaviour.
	if(SpellList[1].Comment == NULL){
		InitSpellsLegacy();
	}
}
#endif
